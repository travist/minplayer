(function() {
  ...
  Drupal.media.compatibility = function() {
    if( !Drupal.media.playTypes ) {
      ...
      Drupal.media.playTypes = getPlayTypes();
    }

    // Return the types of media that are compatible with this browser.
    return Drupal.media.playTypes;
  };
});
